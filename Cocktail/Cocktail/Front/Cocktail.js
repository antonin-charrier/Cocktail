...
var author$project$Board$NoPiece = function (a) {
	return {$: 'NoPiece', a: a};
};
var author$project$Board$Player1 = {$: 'Player1'};
var author$project$Board$Turn = function (a) {
	return {$: 'Turn', a: a};
};
...
var author$project$Board$initialModel = {
	...
	state: author$project$Board$Turn(author$project$Board$Player1)
};
var author$project$Board$Player2 = {$: 'Player2'};
var author$project$Board$Win = function (a) {
	return {$: 'Win', a: a};
};
...
var author$project$Piece$fullMoves = F3(
	function (moves, multiplicator, coordinates) {
		return A2(
			elm$core$List$map,
			author$project$Piece$fullMoveWithCoordinates(coordinates),
			A2(
				elm$core$List$map,
...
var author$project$Piece$reduceRegularMoves = F2(
	function (coordinatesA, coordinatesB) {
		return _Utils_Tuple2(coordinatesA.a + coordinatesB.a, coordinatesA.b + coordinatesB.b);
	});
...
var author$project$Piece$possibleRegularMoves = function (piece) {
	...
	function (msg, model) {
		...
		switch (focusOn.$) {
						...
						return {
							...
							state: function () {
								...
								if (_n3.$ === 'Turn') {
									var player = _n3.a;
									if (player.$ === 'Player1') {
										return author$project$Board$Turn(author$project$Board$Player2);
									} else {
										return author$project$Board$Turn(author$project$Board$Player1);
									}
								} else {
									var player = _n3.a;
									return author$project$Board$Win(player);
								}
							}()
						};
					case 'NoPiece':
			...
			default:
				...
				var _n5 = model.focusOn;
				switch (_n5.$) {
					case 'FocusedPiece':
						var piece = _n5.a;
						return {
							capturedPiecesBlack: function () {
								var _n6 = pieceToCapture.color;
								if (_n6.$ === 'Black') {
							...
							possibleMoves: _List_Nil,
							state: function () {
								if (_Utils_eq(pieceToCapture.pieceType, author$project$Piece$King)) {
									var _n8 = pieceToCapture.color;
									if (_n8.$ === 'White') {
										return author$project$Board$Win(author$project$Board$Player2);
									} else {
										return author$project$Board$Win(author$project$Board$Player1);
									}
								} else {
									var _n9 = model.state;
									if (_n9.$ === 'Turn') {
...
var author$project$Board$buildAnnounce = function (state) {
	if (state.$ === 'Turn') {
		var player = state.a;
		if (player.$ === 'Player1') {
			return elm$html$Html$text('Player 1 (White), it is your turn to play');
		} else {
			return elm$html$Html$text('Player 2 (Black), it is your turn to play');
		}
	} else {
		var player = state.a;
		if (player.$ === 'Player1') {
			return elm$html$Html$text('Player 1 (White) wins!');
		} else {
			return elm$html$Html$text('Player 2 (Black) wins!');
		}
	}
};
var author$project$Board$ClickOnCase = function (a) {
	return {$: 'ClickOnCase', a: a};
};
...
var author$project$Board$srcImageFromPiece = function (piece) {
	...
	switch (_n0.$) {
		case 'King':
			var _n1 = piece.color;
			if (_n1.$ === 'White') {
				return 'icon.king.light.svg';
			} else {
				return 'icon.king.dark.svg';
			}
		case 'Queen':
			var _n2 = piece.color;
			if (_n2.$ === 'White') {
				return 'icon.queen.light.svg';
			} else {
				return 'icon.queen.dark.svg';
			}
		case 'Bishop':
			var _n3 = piece.color;
			if (_n3.$ === 'White') {
				return 'icon.bishop.light.svg';
			} else {
				return 'icon.bishop.dark.svg';
			}
		case 'Knight':
			var _n4 = piece.color;
			if (_n4.$ === 'White') {
				return 'icon.knight.light.svg';
			} else {
				return 'icon.knight.dark.svg';
			}
		case 'Rook':
			var _n5 = piece.color;
			if (_n5.$ === 'White') {
				return 'icon.rook.light.svg';
			} else {
				return 'icon.rook.dark.svg';
			}
		default:
			var _n6 = piece.color;
			if (_n6.$ === 'White') {
				return 'icon.pawn.light.svg';
			} else {
...
var author$project$Board$buildCase = F3(
	function (model, posX, posY) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('case')
				]),
			function () {
				var _n0 = A2(
					author$project$Board$findCaseFromCoordinates,
				...
				if (_n0.$ === 'Empty') {
					...
					if (!_n3) {
						...
						if (_n4.$ === 'Turn') {
							var player = _n4.a;
							return (_Utils_eq(player, author$project$Board$Player1) && _Utils_eq(piece.color, author$project$Piece$White)) ? _List_fromArray(
								[
									A2(
									elm$html$Html$button,
									_List_fromArray(
								...
								]) : ((_Utils_eq(player, author$project$Board$Player2) && _Utils_eq(piece.color, author$project$Piece$Black)) ? _List_fromArray(
								[
									A2(
									elm$html$Html$button,
									_List_fromArray(
...
var author$project$Board$buildLine = F3(
	function (model, id, max) {
		return (max > 0) ? A2(
			elm$core$List$append,
			_List_fromArray(
				[
					A3(author$project$Board$buildCase, model, max, id)
				]),
			A3(author$project$Board$buildLine, model, id, max - 1)) : _List_Nil;
	});
var author$project$Board$buildBoard = F2(
	function (model, max) {
		return (max > 0) ? A2(
			elm$core$List$append,
			_List_fromArray(
				[
					...
					A3(author$project$Board$buildLine, model, max, 8))
				]),
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('announce')
							]),
						_List_fromArray(
							[
								author$project$Board$buildAnnounce(model.state)
							])),
						A2(
						elm$html$Html$div,
						_List_fromArray(
...
var author$project$Board$main = elm$browser$Browser$sandbox(
	{init: author$project$Board$initialModel, update: author$project$Board$update, view: author$project$Board$view});
_Platform_export({'Board':{'init':author$project$Board$main(
